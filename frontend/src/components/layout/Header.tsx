    ...
    <header className="sticky top-0 z-40 w-full h-16 border-b border-slate-200 dark:border-white/10 bg-white/95 dark:bg-[#05070A]/90 backdrop-blur-2xl px-4 lg:px-6 flex items-center justify-between shadow-[0_4px_20px_rgba(0,0,0,0.05)] dark:shadow-[0_4px_30px_rgba(0,0,0,0.6)] transition-colors duration-200">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="hidden lg:flex items-center gap-2.5 pl-2 border-l border-slate-200 dark:border-white/10">
          <div className="w-7 h-7 rounded-lg bg-gradient-to-tr from-teal-500 to-blue-600 border border-teal-400/50 flex items-center justify-center text-white font-bold text-xs font-mono shadow-sm">
            OP
          </div>
          <div className="text-left font-mono">
            <div className="text-xs font-semibold text-slate-900 dark:text-white leading-none">COMMANDER</div>
            <div className="text-[10px] text-teal-700 dark:text-[#2DD4BF] font-semibold leading-none mt-1">SEC-LEVEL 4</div>
          </div>
        </div>
      </div>
    </header>
